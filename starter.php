<?php
/*
Plugin Name: Wordpress Vue Starter Plugin
...
final class WP_Base_Plugin {
    ...
    public function includes() {
        ...
        if ( $this->is_request( 'admin' ) ) {
            ...
            require_once BASEPLUGIN_INCLUDES . '/Settings.php';
        }
    ...
    public function init_classes() {
        ...
        if ( $this->is_request( 'admin' ) ) {
            ...
            $this->container['settings'] = new App\Settings();
        }
