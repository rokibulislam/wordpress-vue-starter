<template>
    <div>
        <textarea :value="value" :id="'formsuite-tinymce-' + editorId" rows="5"></textarea>
    </div>
</template>
<script>
    export default {
        name:'formsuite-text-editor',
        props: {
            value: {
                type: String,
                required: true
        ...
        data() {
            return {
                ...
                fileFrame: null,
                shortcodes: formSuite.shortcodes,
            };
        },
        ...
        methods: {
            setupEditor(){
                ...
                window.tinymce.init({
                    ...
                    theme: 'modern',
                    skin: 'lightgray',
                    content_css: `${formSuite.assetsURL}/css/customizer.css`,
